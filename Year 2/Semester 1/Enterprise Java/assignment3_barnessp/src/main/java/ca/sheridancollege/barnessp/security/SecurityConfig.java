...
//			this is where i added the roles
...
//	also here for the posting of update insert and delete :)
	.requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.POST, "/update")).hasAnyRole("ADMIN","USER")
	.requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.POST, "/insert")).hasAnyRole("ADMIN","USER")
	.requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.POST, "/delete")).hasRole("ADMIN")
