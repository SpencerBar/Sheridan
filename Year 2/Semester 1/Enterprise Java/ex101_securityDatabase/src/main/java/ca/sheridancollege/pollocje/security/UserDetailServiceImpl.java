package ca.sheridancollege.pollocje.security;
...
import ca.sheridancollege.pollocje.database.DatabaseAccess;
...
public class UserDetailServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		ca.sheridancollege.pollocje.beans.User user = da.findUserAccount(username);
